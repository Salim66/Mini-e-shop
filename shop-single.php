        ...
        <div id="navigation">
          ...
          <ul class="navigation-menu">
            ...
            <li class="has-submenu">
              ...
              <ul class="submenu">
                <li>
                  <a href="shop-4col.php">Show Product</a>
                </li>
                <li>
    ...
    <section>
      <div class="container">
        ...
        <?php 
            ...
            // explode two passing url data and receive list variable
            list($id, $pro) = explode(":", $val);

            // select query from database table and single id receive
          ...
          <div class="row">
            ...
            <div class="col-md-5 col-md-offset-1">
              ...
              <div class="single-product-price">
                <div class="row">
                  <div class="col-xs-6">
                    <h3><del><?php echo $fdata['regular_price']; ?></del><span><?php echo $fdata['sell_price']; ?></span></h3>
                  </div>
        ...
        <div class="product-tabs">
          ...
          <div class="tab-content">
            <div id="first-tab" role="tabpanel" class="tab-pane active">
              <p><?php echo $fdata['product_discription']; ?></p>
            </div>
        ...
        <div class="related-products">
          ...
          <div class="row">
            ...
            <?php 
              ...
              // select query from database product related
              $sql = "SELECT * FROM product_info WHERE product_name='$pro' LIMIT 4";
              $data = $connection -> query($sql);
            ...
            <div class="col-md-3 col-sm-6">
              <div class="shop-product">
                <div class="product-thumb">
                  <a href="shop-single.php?id=<?php echo $fdata['id']; echo ':'; echo $fdata['product_name']; ?>">
                    <img src="photos/<?php echo $fdata['photo']; ?>" alt="">
                  </a>
                </div>
