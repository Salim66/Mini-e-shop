          ...
          <div class="row">
            ...
            <div class="col-sm-4">
             <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                 ...
                 <span class="input-group-btn"><button name="range" type="submit"  class="btn btn-color">Search</button></span>
               </div>
              </form>
            </div>
            <!-- Search form  -->
            <div class="col-sm-5">
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method='POST' class="inline-form">
                  <div class="input-group">
                    <input type="text" name="search" placeholder="Product_Name/Brand/Tag" class="form-control"><span class="input-group-btn"><button name="submit" type="submit" class="btn btn-color">Search</button></span>
                  </div>
                </form>
             </div>
          </div>
            ...
            if ( isset($_POST['submit']) ) {
              ...
              if ( empty($search) ) {
                ...
                if ( empty($price) ) {
                   ...
                   $sql ="SELECT * FROM product_info WHERE sell_price BETWEEN $min AND $max";
                 }
          ...
          <div class="col-md-3 col-sm-6">
            <div class="shop-product">
              <div class="product-thumb">
                ...
                <div class="product-overlay"><a href="shop-single.php?id=<?php echo $fdata['id']; echo ':'; echo $fdata['product_name']; ?>" class="btn btn-color-out btn-sm">View Product<i class="ti-bag"></i></a>
                </div>
              </div>
              <div class="product-info">
                <h4 class="upper"><a href="shop-single.php?id=<?php echo $fdata['id'];  echo ':'; echo $fdata['product_name']; ?>"><?php echo $fdata['product_name'] ?></a></h4><span>Regular_price: <del><?php echo $fdata['regular_price'] ?></del></span><br><span style="color:#000000FF">Sell_price: <?php echo $fdata['sell_price'] ?></span>
